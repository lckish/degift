                                    ...
                                    <div class="row">
                                        <div class="menu-info d-flex justify-content-between align-items-center">
                                            <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                                                href="index.html" class="logo"> <img src="{{asset('assets/images/logo/logo.png')}}"
                                                                                     alt=""> </a>
                    ...
                    <div class="d-lg-block d-none">
                        <div class="row g-0 position-relative">
                            <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                                <div class="logo"> <a href="index.html"> <img src="{{asset('assets/images/logo/logo.png')}}" alt=""> </a>
                                </div>
                            </div>
                    ...
                    <div class="mobile-menu__menu-top border-bottom-0">
                        <div class="container">
                            <div class="row">
                                <div class="menu-info d-flex justify-content-between align-items-center">
                                    <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                                        href="index.html" class="logo"> <img src="{{asset('assets/images/logo/logo.png')}}" alt=""> </a>
                                    <div class="cart-holder">
                                        <a href="#0" class="cart cart-icon position-relative">
                                            <i class="flaticon-shopping-cart"></i>
                                        </a>
        ...
        <main class="overflow-hidden">
                ...
                <div class="row align-items-center justify-content-sm-between">
                    <div class="col-lg-5 d-lg-block d-none">
                        <div class="newsLetter-popup__thumb imgenews">
                            <img src="{{asset('assets/images/home-three/products-1.jpg')}}" alt="newsletter">
                        </div>
                    </div>
                 ...
                 "fade": false, "pauseOnHover": false}'>
                    ...
                    <div class="slide">
                        <div class="contant-box position-relative">
                            ...
                            <img class="bg-img hundread-vh" src="{{asset('assets/images/home-three/home-3-bg.jpg')}}" alt="image">
                    ...
                    <div class="slide">
                        <div class="contant-box position-relative">
                            ...
                            <img class="bg-img hundread-vh" src="{{asset('assets/images/home-three/home-3-bg-2.jpg')}}" alt="image">
                    ...
                    <div class="row mt--30">
                        <div class="col-lg-6 h-100 mt-30">
                            <a href="shop-grid.html" class="catagory-single one home3cat">
                                <img src="{{asset('assets/images/home-three/cat-1.png')}}" alt="#" class="background-img bg-img imgone">
                                <div class="content">
                            ...
                            <div class="row">
                                <div class="co-12 mt-30 ">
                                    <a href="shop-grid.html" class="catagory-single home3cat">
                                        <img src="{{asset('assets/images/home-three/catbg-3.png')}}" alt=""
                                ...
                                <div class="col-12 mt-30">
                                    <a href="shop-grid.html" class="catagory-single home3cat">
                                        <img src="{{asset('assets/images/home-three/catbg-2.png')}}" alt=""
                                             class="background-img bg-img">
                                        <div class="content">
                                            <div class="row w-100 h-100 align-items-center">
                                ...
                                <div class="catagory-slider-three">
                                        ...
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/products-1.jpg')}}" class="first-img"
                                                         alt="" />
                                                    <img src="{{asset('assets/images/home-three/products-hover-1.png')}}" alt=""
                                                         class="hover-img" />
                                                </a>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/products-2.jpg')}}" alt="" />
                                                </a>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/products-3.jpg')}}" class="first-img"
                                                         alt="" />
                                                    <img src="{{asset('assets/images/home-three/products-hover-3.png')}}" alt=""
                                                         class="hover-img" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/products-4.jpg')}}" alt="" />
                                                </a>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img img-bg">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/products-5.png')}}" alt="" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/products-6.png')}}" alt="" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                                                        class="addcart btn--primary style2"> Add To Cart </a>
                                ...
                                <div class="catagory-slider-three">
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss2-1.jpg')}}" class="first-img"
                                                         alt="" />
                                                    <img src="{{asset('assets/images/home-three/productss2-hover-1.png')}}" alt=""
                                                         class="hover-img" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_base badge new ">New</span> <span
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss2-2.jpg')}}" alt="" />
                                                </a>
                                                <a href="cart.html" class="addcart btn--primary style2">
                                                    Add To Cart </a>
                                                <div class="products-grid__usefull-links">
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss2-3.jpg')}}" class="first-img"
                                                         alt="" />
                                                    <img src="{{asset('assets/images/home-three/productss2-hover-3.png')}}" alt=""
                                                         class="hover-img" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss2-4.jpg')}}" alt="" />
                                                </a>
                                                <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                                <div class="products-grid__usefull-links">
                                                    <ul>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img img-bg">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss2-5.jpg')}}" alt="" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_black badge discount">-10%</span> </div> <a
                                                    href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                ...
                                <div class="catagory-slider-three">
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss3-1.jpg')}}" class="first-img"
                                                         alt="" />
                                                    <img src="{{asset('assets/images/home-three/productss3-hover-1.jpg')}}" alt=""
                                                         class="hover-img" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_base badge new ">New</span> <span
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss3-2.jpg')}}" alt="" />
                                                </a>
                                                <a href="cart.html" class="addcart btn--primary style2">
                                                    Add To Cart </a>
                                                <div class="products-grid__usefull-links">
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss3-3.jpg')}}" class="first-img"
                                                         alt="" />
                                                    <img src="{{asset('assets/images/home-three/productss3-hover-3.png')}}" alt=""
                                                         class="hover-img" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss3-4.jpg')}}" alt="" />
                                                </a>
                                                <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                                <div class="products-grid__usefull-links">
                                                    <ul>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img img-bg">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss3-5.png')}}" alt="" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_black badge discount">-10%</span> </div> <a
                                                    href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                <a href="shop-details-3.html" class="d-block">
                                                    <img src="{{asset('assets/images/home-three/productss3-3.jpg')}}" alt="" />
                                                </a>
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                                                        class="addcart btn--primary style2"> Add To Cart </a>
                        ...
                        <div class="col-xl-6 wow fadeInLeft animated ">
                            <div class="video-main-box position-relative">
                                <div class="video-two__img"
                                     style="background-image: url({{asset('assets/images/home-three/video-v2-img1.jpg')}});">
                            ...
                            <div class="products-three__inner">
                                <ul>
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block"> <img
                                                    src="{{asset('assets/images/home-three/productss2-1.jpg')}}" class="first-img"
                                                    alt="" /> <img src="{{asset('assets/images/home-three/productss2-hover-1.png')}}"
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{asset('assets/images/home-three/productss2-hover-2.png')}}" class="first-img"
                                                     alt="" />
                                                <img src="{{asset('assets/images/home-three/productss2-2.jpg')}}" alt=""
                                                     class="hover-img" />
                                            </a>
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{asset('assets/images/home-three/productss2-3.jpg')}}" alt="" />
                                            </a>
                                    ...
                                    <li class="products-three-single  wow fadeInUp animated">
                                        <div class="products-three-single-img"> <a href="shop-details-3.html"
                                                                                   class="d-block"> <img src="{{asset('assets/images/home-three/productss2-4.jpg')}}"
                                                                                                         alt="" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                    ...
                                    <li class="products-three-single   wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{asset('assets/images/home-three/productss2-5.jpg')}}" class="first-img"
                                                     alt="" />
                                                <img src="{{asset('assets/images/home-three/productss2-hover-5.png')}}" alt=""
                                                     class="hover-img" />
                                            </a>
                                            <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img"> <a href="shop-details-3.html"
                                                                                   class="d-block"> <img src="{{asset('assets/images/home-three/productss3-2.jpg')}}"
                                                                                                         alt="" />
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{asset('assets/images/home-three/productss3-3.jpg')}}" alt="" /> </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                                                    class="addcart btn--primary style2"> Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img"> <a href="shop-details-3.html"
                                                                                   class="d-block"> <img src="{{asset('assets/images/home-three/productss3-4.jpg')}}"
                                                                                                         alt="" />
                                            </a> <a href="cart.html" class="addcart btn--primary style2">
                                                Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img img-bg">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{asset('assets/images/home-three/productss2-1.jpg')}}" alt="" />
                                                <div class="products-grid-one__badge-box"> <span
                                                        class="bg_black badge discount">-10%</span> </div> <a
                                                    href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                                <div class="products-grid__usefull-links">
                                                                        ...
                                                                        <div class="popup-product-main-image-box">
                                                                            <div id="tab11111"
                                                                                ...
                                                                                <div class="popup-product-single-image">
                                                                                    <img src="{{asset('assets/images/shop/products-v6-img5.jpg')}}"
                                                                                         alt="" /> </div>
                                                                            </div>
                                                                            <div id="tab22222"
                                                                                 class="tab-item popup-product-image">
                                                                                <div class="popup-product-single-image">
                                                                                    <img src="{{asset('assets/images/shop/products-v6-img6.jpg')}}"
                                                                                         alt="" /> </div>
                                                                            </div>
                                                                            <div id="tab33333"
                                                                                 class="tab-item popup-product-image">
                                                                                <div class="popup-product-single-image">
                                                                                    <img src="{{asset('assets/images/shop/products-v6-img7.jpg')}}"
                                                                                         alt="" /> </div>
                                                                            </div> <button class="prev"> <i
                            ...
                            <div class="product-slider-main position-relative ">
                                <div class="product-slider__single text-center">
                                    <div
                                        ...
                                        <div class="img-box">
                                            <img src="{{asset('assets/images/home-three/fimg.png')}}" alt="" />
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="newsLetter-one__content-box d-flex align-items-center justify-content-md-start justify-content-center wow fadeInUp animated"
                                 data-wow-delay="0.1s">
                                <div class="thumb"> <img src="{{asset('assets/images/home-two/envalop.png')}}" alt=""> </div>
                                    ...
                                    <div class="row  justify-content-center">
                                            ...
                                            <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                                                <div class="categories-three__list-item-inner"> <a
                                                        href="shop-grid-right-sidebar.html" class="img-box"> <img
                                                            src="{{asset('assets/images/home-three/categories-v2-img1.jpg')}}" alt="" />
                                            ...
                                            <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                                                <div class="categories-three__list-item-inner"> <a
                                                        href="shop-grid-left-sidebar.html" class="img-box"> <img
                                                            src="{{asset('assets/images/home-three/categories-v2-img2.jpg')}}" alt="" />
                                                        <div class="text"> <span>369 Items</span> </div>
                                                    </a>
                                                    <div class="title text-center">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                                                <div class="categories-three__list-item-inner"> <a
                                                        href="shop-grid-left-sidebar.html" class="img-box"> <img
                                                            src="{{asset('assets/images/home-three/categories-v2-img3.jpg')}}" alt="" />
                                                        <div class="text"> <span>369 Items</span> </div>
                                                    </a>
                                                    <div class="title text-center">
                    ...
                    <div class="row mt--30">
                        <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.2s">
                            <div class="core-features__box d-flex ms-0"> <span class="one"></span> <span class="two"></span>
                                <div class="icon"> <img src="{{asset('assets/images/icon/f-icon-1.png')}}" alt=""> </div>
                        ...
                        <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.3s">
                            <div class="core-features__box d-flex "> <span class="one"></span> <span class="two"></span>
                                <div class="icon"> <img src="{{asset('assets/images/icon/f-icon-2.png')}}" alt=""> </div>
                                <div class="core-features__box-content"> <a href="login.html" class="d-block">
                        ...
                        <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.4s">
                            <div class="core-features__box d-flex "> <span class="one"></span> <span class="two"></span>
                                <div class="icon"> <img src="{{asset('assets/images/icon/f-icon-3.png')}}" alt=""> </div>
                                <div class="core-features__box-content"> <a href="login.html" class="d-block">
                                        <h4> Return & Refund </h4>
                                    </a>
                                    <p>Everybody different which the why give offer styles for every body.</p>
                        ...
                        <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.5s">
                            <div class="core-features__box d-flex me-0"> <span class="one"></span> <span class="two"></span>
                                <div class="icon"> <img src="{{asset('assets/images/icon/f-icon-4.png')}}" alt=""> </div>
                                <div class="core-features__box-content"> <a href="login.html" class="d-block">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
                            <div class="blog-three__single mt-30"> <a href="blog-single.html"
                                                                      class="blog-three__single-img d-block"> <img src="{{asset('assets/images/blog/blog-v3-2.jpg')}}"
                                                                                                                   alt="" /> </a>
                                <div class="blog-three__single-content text-center"> <span>Vendora Style</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
                            <div class="blog-three__single mt-30"> <a href="blog-single.html"
                                                                      class="blog-three__single-img d-block"> <img src="{{asset('assets/images/blog/blog-v3-3.jpg')}}"
                                                                                                                   alt="" /> </a>
                                <div class="blog-three__single-content text-center"> <span>Vendora Style</span>
            ...
            <div class="gallery-two wow fadeInUp animated overflow-hidden">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="gallery-two__slider "> <a href="{{asset('assets/images/home-three/gallery-v2-img1.jpg')}}"
                                                                  class="gallery-two__single"> <img src="{{asset('assets/images/home-three/gallery-v2-img1.jpg')}}"
                                                                                                    alt="" /> <span class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="{{asset('assets/images/home-three/gallery-v2-img2.jpg')}}" class="gallery-two__single"> <img
                                        src="{{asset('assets/images/home-three/gallery-v2-img2.jpg')}}" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="{{asset('assets/images/home-three/gallery-v2-img3.jpg')}}" class="gallery-two__single"> <img
                                        src="{{asset('assets/images/home-three/gallery-v2-img3.jpg')}}" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="{{asset('assets/images/home-three/gallery-v2-img4.jpg')}}" class="gallery-two__single"> <img
                                        src="{{asset('assets/images/home-three/gallery-v2-img4.jpg')}}" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="{{asset('assets/images/home-three/gallery-v2-img5.jpg')}}" class="gallery-two__single"> <img
                                        src="{{asset('assets/images/home-three/gallery-v2-img5.jpg')}}" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="{{asset('assets/images/home-three/gallery-v2-img6.jpg')}}" class="gallery-two__single"> <img
                                        src="{{asset('assets/images/home-three/gallery-v2-img6.jpg')}}" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="{{asset('assets/images/home-three/gallery-v2-img2.jpg')}}" class="gallery-two__single"> <img
                                        src="{{asset('assets/images/home-three/gallery-v2-img2.jpg')}}" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
